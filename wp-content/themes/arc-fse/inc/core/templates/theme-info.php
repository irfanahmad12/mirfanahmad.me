...
<div class="arc-fse--about-page--wrapper">
                        ...
                        <div class="arc-fse-header-right">
                                <div class="arc-fse-card-header-button-group">
                                        <a href="<?php echo $pro_purchase_url; ?>"
                                                ...
                                                <?php printf( esc_html( 'Get Arc Pro', 'arc-fse' ), $theme->Name ); ?>
                                        </a>
                                        ...
                                        <div class="arc-fse-about-container arc-fse-compare-table">
                                                <div class="admin-grid-1">
                                                        ...
                                                        <p class="arc-fse-compare-table-subtitle"><a
                                                                        ...
                                                                        target="__blank">
                                                                        <?php echo esc_html( 'Get Arc Pro', 'arc-fse' ); ?>
                                                                        <i
                                                        ...
                                                        <table>
                                                                <thead>
                                                                        <tr>
                                                                                <th>
																				<?php echo esc_html( $theme->Name ); ?> <?php esc_html_e( 'Free', 'arc-fse' ); ?>
                                                                                </th>
                                                                                <th>
                                                                                        <?php esc_html_e( 'Features', 'arc-fse' ); ?>
                                                                                </th>
                                                                                <th>
																				<?php esc_html_e( 'Arc Pro', 'arc-fse' ); ?>
                                                                                </th>
                                                                        </tr>
                                                                </thead>
                                                                <tbody>
                        ...
                        <div class="arc-fse-about-side">
                                <div class="arc-fse-admin-card member"><span><i class="fa fa-star"
                                        ...
                                        <h4 class="arc-fse-admin-card-title is-small">
                                                ...
                                                giving 5 star on
                                                our profile.', 'arc-fse' ); ?>
                                        </h4><a href="https://wordpress.org/support/theme/arc-fse/reviews/?filter=5"
                                ...
                                <div class="arc-fse-admin-card cart-two">
                                        ...
                                        <p>
                                                ...
                                                class="arc-fse-admin-button primary large"
                        target="_blank">
        ...
        <div class="arc-fse-card-header-button-group">
                <a href="<?php echo $pro_purchase_url; ?>" class="arc-fse-admin-button" rel="noreferrer"
